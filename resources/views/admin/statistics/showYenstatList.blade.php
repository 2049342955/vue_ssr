...
<header id="topbar" class="ph10">
  ...
  <div class="topbar-left col-sm-3">
    <ul class="nav nav-list nav-list-topbar pull-left">
      <li><a href="statistics/yuanstat?status=1" class="btn btn-link {{($status==1)?'btn-active':''}}" style="color: #1D6FC4;">充值记录</a></li>
      <li><a href="statistics/yuanstat?status=2" class="btn btn-link {{($status==2)?'btn-active':''}}" style="color: #1D6FC4;">提现记录</a></li>
    </ul>
  </div>

  <div class="row col-sm-9">
    <form action="statistics/yuanstat/search/{{$status}}">
      <div class="col-sm-10">
