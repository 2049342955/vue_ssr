  ...
  <div class="panel" id="spy3">
      <div class="panel-heading">
		...
		<div class="pull-right hidden-xs">
           <span><a href="information/content_create">新增</a></span>
        </div>
      </div>
					...
					@foreach( $data as $key => $value )
						<tr>
							...
							<td>
								...
								<a href="information/content_update?id={{$value->id}}">编辑</a>
								<a href="information/content_delete?id={{$value->id}}" onclick="deleteConfirm()">删除</a>
							</td>
						</tr>
					@endforeach
				@endif
