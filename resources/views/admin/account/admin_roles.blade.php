  ...
  <div class="panel" id="spy3">
      <div class="panel-heading">
		...
		<div class="pull-right hidden-xs">
           <span><a href="admin_roles_create">新增</a></span>
        </div>
      </div>
					...
					@foreach( $data as $key => $value )
						<tr>
							...
							<td>
								...
								<a href="admin_roles_update?id={{$value->role_id}}">编辑</a>
								@if( $value->locked == 0 )
									<a href="admin_roles_enable?id={{$value->role_id}}">启用</a>
								@elseif( $value->locked == 1 )
									<a href="admin_roles_disable?id={{$value->role_id}}">禁用</a>
								@endif
							</td>
						</tr>
