...
<div id="content">
 <h4>模块管理 - {{ !empty($data) ? '更新' : '新增' }}</h4>
  ...
  <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label class="col-lg-3 control-label">模块英文名称</label>
      <div class="col-lg-8">
        <div class="bs-component">
          <input type="text" name="english_name" class="form-control" placeholder="请输入模块英文名称，必填" value="{{ !empty($data) ? $data['english_name'] : '' }}" required="required">
        </div>
      </div>
    </div>

    <div class="form-group">
      <label class="col-lg-3 control-label">模块俄文名称</label>
      <div class="col-lg-8">
        <div class="bs-component">
          <input type="text" name="russian_name" class="form-control" placeholder="请输入模块俄文名称，必填" value="{{ !empty($data) ? $data['russian_name'] : '' }}" required="required">
        </div>
      </div>
    </div>
