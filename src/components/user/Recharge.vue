  ...
  export default {
    ...
    data () {
      return {
        ...
        processStatus: 2,
        form: [{name: 'amount', type: 'text', title: '充值金额', placeholder: '请输入充值金额', pattern: '^[1-9][0-9]{2,}$', tips: '请输入至少100的整数', len: 7}, {name: 'bank_card', type: 'text', title: '充值银行卡', edit: 'bank_card', showLink: '/user/account'}, {name: 'request_id', type: 'text', title: '充值流水号', placeholder: '请输入充值流水号', pattern: '^[0-9]*$', tips: '请输入多位数字'}]
      }
    },
    methods: {
      submit () {
