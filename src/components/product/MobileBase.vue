<template>
  <div class="mobile_base_info">
    ...
    <div class="first_box">
      ...
      <div class="buy_tips" v-if="detail.DeliveryTime">{{detail.DeliveryTime}}</div>
      ...
      <div class="base_info">
        <div class="item" v-for="n,k in mobileNav">
          <div class="item_data">{{detail[k]}}<span>{{n.unit}}</span></div>
          <div class="item_text">{{n.title}}</div>
        </div>
      </div>
      <div class="base_text" v-if="detail.incomeType">{{detail.incomeType}}</div>
    </div>
  </div>
</template>
