  ...
  export default {
    ...
    data () {
      return {
        ...
        path: {frame_header: ['regist', 'passwordRetrieval', 'user', 'account', '/detail', 'webInfo', 'article/agreement', 'minerShop/miner', '/industryInformation'], border: ['login', 'bdc'], shadow: ['regist', 'passwordRetrieval'], web_box: ['webInfo', 'minerShop/miner']},
        headerClass: ''
      }
    },
    mounted () {
