...
<script>
  ...
  export default {
    ...
    data () {
      return {
        // nav: [{name: 'minerShop', text: '矿机商城', link: '/minerShop/miner/1/all'}, {name: 'compute', text: '算力转让', link: '/compute/list/1/all'}, {name: 'bdc', text: 'BDC托管', link: '/bdc'}, {name: 'news', text: '产业资讯', link: '/webInfo/list/news'}, {name: 'dataTrade', text: '数据交易', link: ''}, {name: 'computeTrade', text: '算法交易', link: ''}],
        nav: [{name: 'minerShop', text: '矿机商城', link: '/minerShop/miner/1/all'}, {name: 'bdc', text: 'BDC托管', link: '/bdc'}, {name: 'news', text: '产业资讯', link: '/webInfo/list/news'}],
