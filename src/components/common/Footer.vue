  ...
  export default {
    data () {
      return {
        ...
        // service: {'算力商城': '/minerShop/miner/1/all', '算力转让': '/compute/list/1/all', '算力托管': '/bdc', '算力资讯': '/webInfo/list/news'},
        service: {'矿机商城': '/minerShop/miner/1/all', 'BDC托管': '/bdc', '产业资讯': '/webInfo/list/news'},
        partner: [],
