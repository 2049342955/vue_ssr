<template>
  <div class="scroll_list" :style="{'transform': 'translate3d(0, ' + translateVal + 'px, 0)', 'transition-duration': loading ? '0ms' : '300ms'}" @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd">
    <slot name="title"></slot>
    <div class="list_box">
      <slot></slot>
      <no-data :product="product" v-if="noData"></no-data>
    </div>
