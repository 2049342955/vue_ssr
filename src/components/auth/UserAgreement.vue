<template>
  <div class="agreement">
    ...
    <div class="box_content">
      <h3>重要提示：</h3>
      <p>浙江算力科技有限公司（以下简称“本公司”）通过旗下运营管理的算力网(www.suanli.com)（以下简称“本网站”）依据本协议的规定向本公司的用户（以下简称“您或用户”）提供与比特币、区块链有关的信息咨询与管理服务。本协议在您和本公司之间具有合同法上的法律效力。为保障您的合法权益，请您在通过本网站注册成为网站用户时，务必仔细阅读以下条款并完全理解本协议的全部内容，特别是其中所涉及的免除及限制本公司责任的条款，对用户权利限制的条款。请您审慎阅读并选择接受或不接受本协议。</p>
      ...
      <p>1.2 点击确认“我已经阅读并且同意”浙江算力科技有限公司网站注册服务协议前的方框。</p>
      ...
      <p>（1）持有中国（包括港澳台地区）有效身份证件的18周岁以上的具有完全民事行为能力的自然人；</p>
      <p>（2）在中国（包括港澳台地区）合法注册的企业法人。</p>
      ...
      <div class="btn"><router-link to="/auth/regist">返回</router-link></div>
    </div>
  </div>
</template>
