...
<script>
  ...
  export default {
    ...
    data () {
      return {
        nav: [{title: '矿机商城', desc: '无忧购买矿机', url: '/minerShop/miner/1/all'}, {title: 'BDC托管', desc: '多个BDC中心', url: '/bdc'}, {title: '产业资讯', desc: '掌握产业动态', url: '/quickNews/list'}, {title: '算力转让', desc: '掌握产业动态', url: '/mobile/information'}],
        data: [1, 1, 1],
