<template>
  <pcpmpute-news v-if="!isMobile"></pcpmpute-news>
  <mcpmpute-news v-else></mcpmpute-news>
</template>
<script>
  import { mapState } from 'vuex'
  import PcpmputeNews from './pc'
  import McpmputeNews from './mobile'
  export default {
    components: {
      PcpmputeNews, McpmputeNews
    },
    data () {
      return {
        active: '',
