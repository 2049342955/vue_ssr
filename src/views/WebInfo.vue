...
<script>
  export default {
    data () {
      return {
        nav: [{name: 'news', title: '产业资讯', path: '/webInfo/list/news'}, {name: 'product', title: '产品公告', path: '/webInfo/list/product'}, {name: 'website', title: '网站动态', path: '/webInfo/list/website'}, {name: 'aboutUs', title: '关于我们', path: '/webInfo/aboutUs'}, {name: 'Issues', title: '常见问题', path: '/webInfo/issues'}],
        no: 0
      }
    },
    created () {
