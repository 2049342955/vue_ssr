  ...
  <div class="currency" v-if="isMobile===0">
    ...
    <div class="currency_items">
      ...
      <div class="currency_item">
        <router-link class="item" :to="'/currency/detail/' + (n.id)" v-for="n, k in mainCurrency" :key="k">
          <img :src="n.icon"/>
      ...
      <div class="currency_item">
        <router-link class="item" :to="'/currency/detail' + (n.id)" v-for="n, k in otherCurrency" :key="k">
          <img :src="n.icon"/>
          <span>{{n.coin_name}}</span>
        </router-link>
      </div>
