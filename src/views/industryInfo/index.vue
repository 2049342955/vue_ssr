  ...
  <div class="cominfor">
    ...
    <div class="cominfor_she">
      <h4>
        ...
        <router-link to="/museum">了解更多 ></router-link>
      </h4>
      <div class="cominfor_shebottom">
        <div class="shebottomleft">
          ...
          <router-link to="/manufacturer">全部厂商介绍 ></router-link>
        </div>
        <div class="shebottomcen">
          ...
          <router-link to="/evaluation">全部测评 ></router-link>
        </div>
        <div class="shebottomright">
          ...
          <router-link to="/museum">全部算力服务器介绍 ></router-link>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        miners: [
          {
            big: require('@/assets/images/information5.jpg'),
            title: '算力服务器-设备之家',
            route: '前往了解 >',
            path: '/museum'
          },
          {
            big: require('@/assets/images/information2.jpg'),
            title: '算力服务器-数字货币',
            route: '前往了解 >',
            path: '/currency'
          },
          {
            big: require('@/assets/images/information3.jpg'),
            title: '平台交易最新资讯',
            route: '前往了解 >',
            path: '/transaction'
          }
    ...
    methods: {
      goDetail (id, type) {
        ...
        if (type === 1) {
          this.$router.push({path: '/museum/detail/'})
        } else if (type === 2) {
          this.$router.push({path: '/evaluation/detail/'})
        } else if (type === 3) {
